...
{
    /// <summary>
    /// .NET binding for PicovoiceApp end-to-end platform. PicovoiceApp enables building voice experiences similar to Alexa but
    /// runs entirely on-device(offline).
    ///
    /// PicovoiceApp detects utterances of a customizable wake word(phrase) within an incoming stream of audio in real-time.
    ...
    ///
    /// PicovoiceApp processes incoming audio in consecutive frames. The number of samples per frame is
    /// `.FrameLength`. The incoming audio needs to have a sample rate equal to `.SampleRate` and be 16-bit
    /// linearly-encoded.PicovoiceApp operates on single-channel audio. It uses Porcupine wake word engine for wake word
    ...
    public class Picovoice : IDisposable
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="accessKey">AccessKey obtained from PicovoiceApp Console (https://console.picovoice.ai/).</param>
        ...
        /// </param>
        /// <returns>An instance of the PicovoiceApp end-to-end platform.</returns>
        ...
        /// <summary>
        /// Releases resources that were acquired by PicovoiceApp.
        /// </summary>
        public void Dispose()
        {
            if (_porcupine != null)
        ...
        /// `.FrameLength`. The incoming audio needs to have a sample rate equal to `.SampleRate` and be 16-bit
        /// linearly-encoded. PicovoiceApp operates on single-channel audio.
        /// </param>
        public void Process(short[] pcm)
        {
            if (pcm == null)
            {
                throw new PicovoiceInvalidArgumentException($"Null audio frame passed to PicovoiceApp");
            }
        ...
        /// <summary>
        /// Resets the internal state of PicovoiceApp. It should be called before processing a new stream of audio
        /// or when PicovoiceApp was stopped while processing a stream of audio.
        /// </summary>
        public void Reset()
        {
            if (_porcupine == null || _rhino == null)
        ...
        /// <summary>
        /// Get the audio sample rate required by PicovoiceApp
        /// </summary>
        /// <returns>Required sample rate.</returns>
        public int SampleRate { get; private set; }

        /// <summary>
        /// Gets the version number of the PicovoiceApp platform
        /// </summary>
        /// <returns>Version of PicovoiceApp</returns>
        ...
        /// <summary>
        /// Maps Porcupine/Rhino Exception to PicovoiceApp Exception
        /// </summary>
